...
import 'package:rutorrentflutter/ui/views/Disk%20Explorer/disk_explorer_viewmodel.dart';
                            ...
                            ? Expanded(
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return DiskFileTileView(model.diskFiles[index], model.path,
                                        model.goBackwards, model.goForwards);
                                  },
                                ),
                              )
                            : Expanded(
