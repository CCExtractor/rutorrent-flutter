...
Map<int,List<String>> notificationInfo = {
  0 : ["Torrent Added Channel","This Channel is for notifying when a new Torrent is added"],
  1 : ["Download Completed Channel","This Channel is for notifying when a download is completed"],
  2 : ["Low Disk Space Channel","This Channel is for notifying when there is Low Disk Space"],
};
